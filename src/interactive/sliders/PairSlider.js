...
import { View, FlatList, StyleSheet, Text, TouchableOpacity, TurboModuleRegistry } from 'react-native';
        ...
        <View style={theme === 'dark' ? styles.itemDark : styles.item}>
            <View>
                ...
                <View style={styles.timeBg}>
                    <Text style={{ fontFamily: 'gilroy-regular', color: '#fff' }}>{item.time}</Text>
                </View>
                <Text style={[theme === 'dark' ? styles.titleDark : styles.title, { fontFamily: 'gilroy-semibold' }]}>{item.title}</Text>

                <View style={styles.buttonContainer}>
                    <TouchableOpacity style={styles.btnHw}>
                        <Text style={{ fontFamily: 'gilroy-semibold' }} onPress={() => navigation.navigate('ReadyHomeWork')}>Домашняя работа</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={theme === 'dark' ? styles.btnAddDark : styles.btnAdd}>

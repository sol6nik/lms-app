import { View, Text, SafeAreaView, ScrollView, TouchableOpacity, StyleSheet, Image, Alert } from 'react-native'
            ...
            <ScrollView>
                <View >
                    {coursesState.map((item) => (
                        <TouchableOpacity key={item.id} style={[styles.card, theme == 'dark' ? stylesDark.block : stylesDark.white]} onPress={()=>Alert.alert('Screen in develope')}>
                            <View style={styles.courseContainer}>
                                <View style={{
                                    ...
                                    <Text style={[styles.courseName, theme == 'dark' ? stylesDark.text : {}, {fontFamily: 'gilroy-semibold'}]}>{item.courseName}</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    ))}
